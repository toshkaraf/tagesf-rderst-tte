...
const mongolEmpireSlidesDE: Slide[] = [
  ...
  { id: 'm20', title: 'Kulturaustausch', content: 'Pax Mongolica ermöglichte Technologietransfer. Chinesisches Schießpulver kam durch Mongolen nach Europa. Arabische Mathematik — nach China. Europäische Handwerker — nach Asien. Mongolen waren Brücke zwischen Zivilisationen.', duration: 3, media: [{ type: 'image', url: '/media/mongol-empire/cultural-exchange.jpg', title: 'Kulturaustausch' }] },
  { id: 'q5', title: 'Quiz', content: '', duration: 2, questions: [
