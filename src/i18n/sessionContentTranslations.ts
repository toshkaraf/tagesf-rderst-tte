...
export function getTranslatedSessionContent(sessionId: string, language: Language): Partial<Session> | null {
  ...
  if (sessionId === 'alexander-anecdotes' && language === 'de') {
    return {
  ...
  if (sessionId === 'ancient-battle-tactics' && language === 'de') {
    return {
      slides: ancientBattleTacticsSlidesDE,
      quiz: ancientBattleTacticsFinalQuizDE
    }
  }

  if (sessionId === 'medieval-battle-tactics' && language === 'de') {
    return {
  ...
  if (sessionId === 'ancient-comic-history' && language === 'de') {
    return {
  ...
  if (sessionId === 'medieval-noble-titles' && language === 'de') {
    return {
