...
const threeDPrintingSlidesDE: Slide[] = [
  ...
  { id: 'p29', title: 'Biodruck: Wie es funktioniert', content: 'Biodrucker druckt lebende Zellen Schicht für Schicht. Zellen in Gel (Hydrogel) — Nährmedium. Zellschicht = 0,1-0,5 mm. Organ = 100-1.000 Schichten. Nach Druck wachsen Zellen und bilden Gewebe. Wachstumszeit: 2-4 Wochen. Drucken jetzt Knorpel, Haut, Gefäße. Vollständige Organe (Herz, Niere) — in Entwicklung, erste Tierversuche.', duration: 3, media: [{ type: 'image', url: '/media/3d-printing-organs/bioprinting-how.jpg', title: 'Biodruck wie es funktioniert' }] },
